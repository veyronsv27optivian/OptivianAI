  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-3">
      {Array.from({ length: count }).map((_, i) => (
        <div key={i} className="rounded-xl border border-slate-200 dark:border-slate-700/50 bg-white dark:bg-slate-800/90 p-4 animate-pulse">
          <div className="flex items-center justify-between mb-2">
            <div className="h-2.5 bg-slate-200 dark:bg-slate-700 rounded w-16" />
            <div className="w-8 h-8 rounded-lg bg-slate-200 dark:bg-slate-700" />
          </div>
          <div className="h-6 bg-slate-200 dark:bg-slate-700 rounded w-24 mb-1.5" />
...
export function ChartSkeleton({ height = 300 }) {
  return (
    <div className="rounded-xl border border-slate-200 dark:border-slate-700/50 bg-white dark:bg-slate-800/90 p-5 animate-pulse">
...
export function SectionSkeleton({ height = 200 }) {
  return (
    <div className="animate-pulse rounded-xl border border-slate-200 dark:border-slate-700/50 bg-white dark:bg-slate-800/90 p-5" style={{ height }}>
      <div className="flex items-center gap-3 mb-4">
        <div className="w-8 h-8 rounded-lg bg-slate-200 dark:bg-slate-700" />
        <div>
          <div className="h-3.5 bg-slate-200 dark:bg-slate-700 rounded w-32 mb-1" />
    ...
    <div className="space-y-5">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="h-5 bg-slate-200 dark:bg-slate-700 rounded w-36 animate-pulse mb-1" />
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="w-20 h-7 rounded-full bg-slate-200 dark:bg-slate-700 animate-pulse" />
          <div className="w-16 h-7 rounded-full bg-slate-200 dark:bg-slate-700 animate-pulse" />
        </div>
      </div>
      ...
      <div className="flex gap-2">
        {[1, 2, 3, 4].map(i => (
          <div key={i} className="h-6 w-28 rounded-full bg-slate-200 dark:bg-slate-700 animate-pulse" />
        ))}
      </div>
